...
def main():
    s = Template(
        "${description} | [Readme](https://github.com/nholuongut/"
        "hosts/blob/master/${location}readme.md) | "
        "[link](https://raw.githubusercontent.com/nholuongut/"
    ...
    size_history_graph = "![Size history](https://raw.githubusercontent.com/nholuongut/hosts/master/hosts_file_size_history.png)"
    for key in keys:
